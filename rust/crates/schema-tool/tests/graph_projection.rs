...
#[test]
fn production_manifest_is_exactly_75_with_41_retained_and_34_component_native_schemas() {
    let root = repo_root();
    ...
    assert_eq!(
        ...
        75,
        "production baseline is 41 retained + 34 component-native schemas"
    );
