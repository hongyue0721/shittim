...
pub const EMBEDDED_SCHEMA_DOCUMENTS: &[(&str, &str)] = &[
    ...
    ("https://schemas.shittim.local/policy/approval_event_allocation/v1", include_str!("../../../../../schemas/source/policy/approval_event_allocation.v1.json")),
    ("https://schemas.shittim.local/policy/approval_record/v2", include_str!("../../../../../schemas/source/policy/approval_record.v2.json")),
    ...
    ("https://schemas.shittim.local/policy/credential_ref/v1", include_str!("../../../../../schemas/source/policy/credential_ref.v1.json")),
    ("https://schemas.shittim.local/policy/local_presence_evidence/v1", include_str!("../../../../../schemas/source/policy/local_presence_evidence.v1.json")),
    ...
    ("https://schemas.shittim.local/policy/permission_decision/v2", include_str!("../../../../../schemas/source/policy/permission_decision.v2.json")),
    ("https://schemas.shittim.local/policy/policy_rule/v2", include_str!("../../../../../schemas/source/policy/policy_rule.v2.json")),
    ("https://schemas.shittim.local/policy/remote_approval_challenge/v1", include_str!("../../../../../schemas/source/policy/remote_approval_challenge.v1.json")),
    ("https://schemas.shittim.local/policy/remote_approval_response/v1", include_str!("../../../../../schemas/source/policy/remote_approval_response.v1.json")),
    ("https://schemas.shittim.local/policy/remote_approval_signature_preimage/v1", include_str!("../../../../../schemas/source/policy/remote_approval_signature_preimage.v1.json")),
    ("https://schemas.shittim.local/policy/remote_signature_algorithm/v1", include_str!("../../../../../schemas/source/policy/remote_signature_algorithm.v1.json")),
    ("https://schemas.shittim.local/policy/subject_projection/v1", include_str!("../../../../../schemas/source/policy/subject_projection.v1.json")),
    ("https://schemas.shittim.local/policy/system_authentication_challenge/v1", include_str!("../../../../../schemas/source/policy/system_authentication_challenge.v1.json")),
    ("https://schemas.shittim.local/policy/system_authentication_evidence/v1", include_str!("../../../../../schemas/source/policy/system_authentication_evidence.v1.json")),
