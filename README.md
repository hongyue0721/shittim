...
- [`docs/api/README.md`](docs/api/README.md)：KCP、事件与错误文档入口；Schema/生成类型、Task create/get repository 与三个不可连接 typed handler 已实现，但 raw preflight、`agentd` 与可连接 server 尚未实现。
