...
| JCS 向量 | `schemas/examples/jcs/`、`schemas/fixtures/kcp/task_create_normalized_hash.v1.json` | 现有 RFC 8785 示例与既有 fixture；本批 official JCS/hash fixtures 尚未完成 |
...
- official JCS/hash fixtures（本阶段仅 Schema/typed conformance + inline JSON）；
