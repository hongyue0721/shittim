...
- 状态：accepted
- 日期：2026-07-16
- 修订：2026-07-16（补充实际 crate/命令选型）；string enum `ALL` 闭集与自动合同测试已落地，domain-task 手写 catalog 待删
